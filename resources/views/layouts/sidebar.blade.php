    ...
    <div class="sidebar">
        ...
        <nav class="mt-2">
            <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link {{ request()->is('admin/admin','admin/buyer','admin/admin/*/edit','admin/teachers','admin/workers') ? 'active' : '' }}">
                ...
                <li class="nav-item active">
                    <a href="{{ route('clients.index') }}" class="nav-link {{ request()->is('clients') ? 'active' : '' }}">
                        ...
                        <p>
                            Clients
                            <span class="right badge badge-success">{{ \App\Models\Client::all()->count() }}</span>
                        </p>
                    </a>
                </li>
